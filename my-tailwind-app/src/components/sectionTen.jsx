...
export default function SectionTen() {
  return (
    <>
      <div className="bg-[#262835] flex items-start justify-between 2xl:px-[266px] px-[40px] pt-[98px] pb-[70px]  max-[1350px]:py-[70px] max-[1100px]:flex-col  max-[1100px]:items-start ">
        {/* Contact Us Column */}
      ...
      <div className="bg-[#262835] text-center border-t border-white">
        <h1 className="text-lg font-bold text-gray-500 py-[30px]">
